                ...
                <?php if ($currentUser->hasAttribute('user')) { ?>
                    ...
                    <li class="dropdown nav-item">
                        <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false">
                            <img src="<?php echo htmlspecialchars($currentUser->getAttribute('user')->getProfileImage()) ?>" alt="Circle Image" class="rounded-circle img-fluid" style="height: 25px">
                            <?php echo htmlspecialchars($currentUser->getAttribute('user')->getUserName()) ?>
