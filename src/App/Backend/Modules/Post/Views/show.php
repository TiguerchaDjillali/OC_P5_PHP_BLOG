            ...
            <div class="row">
                ...
                <div class="col-12 ">
                    ...
                    <div id="comment-<?php echo htmlspecialchars($comment->getId()) ?>"
                         class="media px-3 card <?php echo $comment->getValid() == 0 ? 'bg-dark' : '' ?>">
                        <div class="media-body col-12 ">
                            ...
                            <form action="/admin/comment-moderate-<?php echo htmlspecialchars(urlencode($comment->getId())) ?>.html" method="post">
