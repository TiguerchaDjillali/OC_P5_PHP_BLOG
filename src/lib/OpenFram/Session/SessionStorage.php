...
namespace  OpenFram\Session;

use  OpenFram\Session\SessionBagInterface;
use  OpenFram\Session\SessionStorageInterface;

use OpenFram\Session\SessionUtils;
use OpenFram\Session\SessionHandler;
...
class SessionStorage implements SessionStorageInterface
{
    ...
    public function setSaveHandler($saveHandler = null)
    {
        if (!$saveHandler instanceof \SessionHandlerInterface &&
            null !== $saveHandler) {
            throw new \InvalidArgumentException('Must  implement \SessionHandlerInterface; or be null.');
        }
